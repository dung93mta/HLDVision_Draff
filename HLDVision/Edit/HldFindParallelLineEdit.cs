...
{
    public partial class HldFindParallelLineEdit : HldToolEditBase
    {
        public HldFindParallelLineEdit()
        {
            InitializeComponent();
            InitBinding();
            this.SubjectChanged += FindParallelLineEdit_SubjectChanged;
            ...
            this.dg_FindLIne_Result.KeyDown += FindParallelLineEdit_KeyDown;
        ...
        void FindParallelLineEdit_KeyDown(object sender, KeyEventArgs e)
        {
            this.dg_FindLIne_Result.CellValueChanged -= dg_FindLIne_Result_CellValueChanged;
        ...
        void FindParallelLineEdit_SubjectChanged(object sender, HldToolBase tool)
        {
        ...
        public HldFindParallelLine Subject
        {
            get { return base.GetSubject() as HldFindParallelLine; }
        ...
        void InitBinding()
        {
            source = new BindingSource(typeof(HldFindParallelLine), null);
            ...
            cb_FindLIne_IgnoreType.DataSource = HldFindParallelLine.IgnoreTypeList.Values.ToList();
            ...
            cb_ParallelOption.DisplayMember = "Key"; cb_ParallelOption.ValueMember = "Value";
            cb_ParallelOption.DataSource = Enum.GetValues(typeof(FindLinefromRefLineOption)).Cast<FindLinefromRefLineOption>().ToDictionary(obj => obj.ToString(), obj => obj).ToList();
            cb_ParallelOption.DataBindings.Add("SelectedValue", source, "ParallelOption", true, DataSourceUpdateMode.OnPropertyChanged);

            nud_Distance.DataBindings.Add("Value", source, "DistanceFromRef", true, DataSourceUpdateMode.OnPropertyChanged);
        }
        ...
        [Browsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public List<HldFindParallelLine.FindLineResult> FindLineResult
        {
