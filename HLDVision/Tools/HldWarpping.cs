...
{
    [Serializable]
    public class HldWarpping : HldToolBase
    {
        public HldWarpping()
        { }

        public HldWarpping(SerializationInfo info, StreamingContext context) : base(info, context) { }
        ...
        public HldPoint InputPoint
        {
            get
            {
                ...
                Point3d p = HldFunc.ImageToFixture3D(HldFunc.FixtureToImage3D(inputPt.Point3d, inputPt.TransformMat), InputImage.TransformMat);
        ...
        public HldPolyLine OutPolyLine
        {
            ...
            set { /* 여기에 outPLineObject = value; 있으면 outPLineObject 저장 안됨!! outPLineObject는 inParam이기도 하고 outParam이기도 함 */ }
        }
        ...
        public HldRectangle OutRectObject
        {
            ...
            set
            {
                outRectObject = value;
                if (value == null) return;
                NotifyPropertyChanged("OutRectObject");
            }
        }
        ...
        [OutputParam]
        public HldPolyLine OutLayoutPLine
        {
            get { return mOutLayoutPLine; }
            set { }
        }
        HldPolyLine mOutLayoutPLine = new HldPolyLine(4);
        #endregion
        ...
        public override void InitOutProperty()
        {
            ...
            OutputImage = null;
            OutputPoint = null;
            mOutLayoutPLine.PolyLinePts = new HldPoint[4];
        ...
        public void DrawWarppingPoint(Display.HldDisplayView display)
        {
            ...
            if (OutputPoint != null)
            {
                ...
                display.GraphicsCollection.Add(OutLayoutPLine);
            }
        }
        ...
        public override void Run(bool isEditMode = false)
        {
            ...
            if (InputPoint != null)
            {
                ...
                Point2d[] inImagePts = new Point2d[4] { new Point2d(0, 0), new Point2d(InputImage.Width, 0), new Point2d(InputImage.Width, InputImage.Height), new Point2d(0, InputImage.Height) };
                Point2d[] outImagePts = Cv2.PerspectiveTransform(inImagePts, H);

                for (int i = 0; i < 4; i++)
                    mOutLayoutPLine[i] = new PointF((float)outImagePts[i].X, (float)outImagePts[i].Y);
                mOutLayoutPLine.Color = Color.BlueViolet;
            }
        ...
        HldPoint[] getArrayFromRect(Rectf rect)
        {
            ...
            pF[1] = new HldPoint(rect.X + rect.Width, rect.Y);
            pF[2] = new HldPoint(rect.X + rect.Width, rect.Y + rect.Height);
            pF[3] = new HldPoint(rect.X, rect.Y + rect.Height);
            return pF;
        }
    }
}
