...
{
    [Serializable]
    public class HldRectangle : InteractDrawObject
    {
        public HldRectangle()
        {

        }
        public HldRectangle(float x, float y, float width, float height)
        {
            rectf.X = x;
            rectf.Y = y;
            Width = width;
        ...
        public HldRectangle(OpenCvSharp.CPlusPlus.Point2f location, float width, float height)
        {
        ...
        public HldRectangle(PointF location, float width, float height) : this(location.X, location.Y, width, height) { }
        public HldRectangle(Rectf rect) { rectf = rect; }
        ...
        public Point2f[] Pts2fImage
        {
            get
            {
                ...
                pts[0] = HldFunc.FixtureToImage2F(new Point2f(rectf.Left, rectf.Top), TransformMat);
                pts[1] = HldFunc.FixtureToImage2F(new Point2f(rectf.Right, rectf.Top), TransformMat);
                pts[2] = HldFunc.FixtureToImage2F(new Point2f(rectf.Right, rectf.Bottom), TransformMat);
                pts[3] = HldFunc.FixtureToImage2F(new Point2f(rectf.Left, rectf.Bottom), TransformMat);
        ...
        public OpenCvSharp.CPlusPlus.Point[] PtsImage
        {
            get
            {
                OpenCvSharp.CPlusPlus.Point[] pts = new OpenCvSharp.CPlusPlus.Point[4];

                pts[0] = HldFunc.FixtureToImage2F(new OpenCvSharp.CPlusPlus.Point(rectf.Left, rectf.Top), TransformMat);
                pts[1] = HldFunc.FixtureToImage2F(new OpenCvSharp.CPlusPlus.Point(rectf.Right, rectf.Top), TransformMat);
                pts[2] = HldFunc.FixtureToImage2F(new OpenCvSharp.CPlusPlus.Point(rectf.Right, rectf.Bottom), TransformMat);
                pts[3] = HldFunc.FixtureToImage2F(new OpenCvSharp.CPlusPlus.Point(rectf.Left, rectf.Bottom), TransformMat);

                return pts;
            }
        }

        public OpenCvSharp.CPlusPlus.Point[] Pts
        {
            get
            {
                OpenCvSharp.CPlusPlus.Point[] pts = new OpenCvSharp.CPlusPlus.Point[4];
                ...
                pts[1] = new OpenCvSharp.CPlusPlus.Point(rectf.Right - rectf.Left, 0);
                pts[2] = new OpenCvSharp.CPlusPlus.Point(rectf.Right - rectf.Left, rectf.Bottom - rectf.Top);
                pts[3] = new OpenCvSharp.CPlusPlus.Point(0, rectf.Bottom - rectf.Top);
